      ...
      <div className="Main__container">
        ...
        >
          <p className="text-justify text__container lh-lg show">
            Respetando lo establecido en la legislación vigente, FAMIR Centro
          ...
          <div className="text-start mt-5">
            ...
            <p className="text-justify text__container lh-lg show">
              Esta política de privacidad está adaptada a la normativa española
              y europea vigente en materia de protección de datos personales en
          ...
          <div className="text-start mt-5">
            ...
            <p className="text-justify text__container lh-lg show">
              ...
              en FAMIR Centro es: Mirtza Rodríguez Rodríguez, RUT: 14.655.581-0
              (en adelante, responsable del tratamiento). Sus datos de contacto
              son los siguientes:
            </p>
            <p className="text-justify text-font lh-lg show">
              Dirección: San Isidro 379, depto. 22. Santiago de Chile
            </p>
            <p className="text-justify text-font lh-lg show">
              Télefono de contacto: +56 9 7395 2562
            </p>
            <p className="text-justify text-font lh-lg show">
              Email de contacto:{" "}
              <a
          ...
          <div className="text-start mt-5">
            ...
            <p className="text-justify text__container lh-lg show">
              ...
              informamos que los datos personales recabados por Famir Centro
              ...
              entre FAMIR Centro y el Usuario o el mantenimiento de la relación
              que se establezca en los formularios que este rellene, o para
              atender una solicitud o consulta del mismo. Asimismo, de
              conformidad con lo previsto en el RGPD y la LOPD-GDD, salvo que
              sea de aplicación la excepción prevista en el artículo 30.5 del
              ...
              llevadas a cabo y las demás circunstancias establecidas en el
              RGPD.
            </p>
          </div>
          <div className="text-start mt-5">
          ...
          <div className="text-start mt-5">
            ...
            <p className="text-justify text__container lh-lg show">
              Las categorías de datos que se tratan en FAMIR Centro son
              únicamente datos identificativos. En ningún caso, se tratan
              categorías especiales de datos personales en el sentido del
              artículo 9 del RGPD.
            </p>
          </div>
          <div className="text-start mt-5">
            ...
            <p className="text-justify text__container lh-lg show">
              ...
              únicamente durante el siguiente plazo: 24 meses, o hasta que el
              ...
              conservarán los datos personales o, cuando eso no sea posible, los
          ...
          <div className="text-start mt-5">
            ...
            <p className="text-justify text__container lh-lg show">
              FAMIR Centro se compromete a adoptar las medidas técnicas y
              organizativas necesarias, según el nivel de seguridad adecuado al
              riesgo de los datos recogidos, de forma que se garantice la
              ...
              <br />
              <br />
              Sin embargo, debido a que FAMIR Centro no puede garantizar la
              inexpugnabilidad de internet ni la ausencia total de hackers u
              otros que accedan de modo fraudulento a los datos personales, el
              Responsable del tratamiento se compromete a comunicar al Usuario
              sin dilación indebida cuando ocurra una violación de la seguridad
              de los datos personales que sea probable que entrañe un alto
              riesgo para los derechos y libertades de las personas físicas.
              Siguiendo lo establecido en el artículo 4 del RGPD, se entiende
              por violación de la seguridad de los datos personales toda
              ...
              Responsable del tratamiento, quien se compromete a informar y a
              garantizar por medio de una obligación legal o contractual que
              dicha confidencialidad sea respetada por sus empleados, asociados,
              y toda persona a la cual le haga accesible la información.
            </p>
          </div>
        </div>
      </div>
