...
const FormProfesor: React.FC = () => {
  ...
  const handleFormSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    if (
      !(
        exprRegular.nombre.test(profesor.nombre + "") &&
        exprRegular.nombre.test(profesor.apellido + "") &&
        exprRegular.correo.test(profesor.correo + "") &&
        exprRegular.nombre.test(profesor.profesion + "") &&
        exprRegular.telefono.test(profesor.telefono + "") &&
        exprRegular.rut.test(profesor.rut + "") &&
        profesor.id_pais_nacimiento &&
        profesor.id_pais_residencia
      )
    )
              ...
              <div className="col-md-6 ms-0 ms-lg-3">
                <form onSubmit={handleFormSubmit}>
                  ...
                  <div className="form-floating mb-3 position-relative">
                    ...
                    />
                    <label htmlFor="floatingInputApellido">
                      Apellido Profesor
                    </label>
                  ...
                  <div className="form-floating mb-3">
                    <select
                      value={profesor.id_pais_nacimiento}
                      id="floatingInputPais1"
                      onChange={handleInputChange}
                    ...
                    <label htmlFor="floatingInputPais1">
                      Pais de Nacimiento
                    </label>
                  </div>
                  <div className="form-floating mb-3">
                    <select
                      value={profesor.id_pais_residencia}
                      id="floatingInputPais"
                      onChange={handleInputChange}
                      className="form-select"
                    ...
                    <label htmlFor="floatingInputPais">
                      Pais de Residencia
                    </label>
                  </div>
                  <div className="form-floating mb-3 position-relative">
